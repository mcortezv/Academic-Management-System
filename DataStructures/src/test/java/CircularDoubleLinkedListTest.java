...
public class CircularDoubleLinkedListTest {
    private CircularDoubleLinkedList<Integer> listaInteger;
    private CircularDoubleLinkedList<String> listaString;

    @BeforeEach
    void setUp() {
        listaInteger = new CircularDoubleLinkedList<>();
        listaString = new CircularDoubleLinkedList<>();
    }
