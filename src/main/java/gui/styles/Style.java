...
public class Style {
    ...
    public static final Color PANEL_COLOR = DARK_MODE ? new Color(33, 33, 33) : new Color(250, 250, 252);
    public static final Color BACKGROUND_COLOR = DARK_MODE ? new Color(40, 40, 42) : new Color(240, 240, 245);
    public static final Color BUTTON_COLOR = DARK_MODE ? new Color(171, 62, 216) : new Color(44, 62, 80);
    public static final Color BUTTON_COLOR_HOVER = DARK_MODE ? new Color(127, 0, 178) : new Color(52, 73, 94);
