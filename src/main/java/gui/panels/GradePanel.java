...
public class GradePanel extends Panel {
    ...
    public void startComponents() {
        ...
        //Botones
        btnAddGrade.setPreferredSize(new Dimension(175, 30));
        btnUpdateGrade.setPreferredSize(new Dimension(175, 30));
        btnDeleteGrade.setPreferredSize(new Dimension(175, 30));
        btnListGrades.setPreferredSize(new Dimension(175, 30));
        btnAverageStudent.setPreferredSize(new Dimension(175, 30));
